...
const BookTitlePage = (props: { complementaryColor, page, setCover?, coverImage?, setCoverColor?, coverColor?, handleBookClick?, children? }) => {
  ...
  const handleCoverClick = () => {
    console.log("hit")
    if (props.handleBookClick && selectedCoverImage && overlayColor) {
